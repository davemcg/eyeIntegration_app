               ...
               navbarMenu('Data',
                          ...
                          tabPanel('Data Download',
                                   fluidPage(
                                     ...
                                     fluidRow(tags$a(href='https://hpc.nih.gov/~mcgaugheyd/eyeIntegration/2017_metadata_02.tsv.gz',
                                                     '2017_metadata_02.tsv.gz')),
                                     fluidRow(tags$a(href='https://hpc.nih.gov/~mcgaugheyd/eyeIntegration/2017_gene_TPM_02.tsv.gz',
                                                     '2017_gene_TPM_02.tsv.gz')),
                                     fluidRow(tags$a(href='https://hpc.nih.gov/~mcgaugheyd/eyeIntegration/2017_tx_TPM_02.tsv.gz',
                                                     '2017_tx_TPM_02.tsv.gz')),
                                     fluidRow(tags$a(href='https://hpc.nih.gov/~mcgaugheyd/eyeIntegration/2019_metadata_02.tsv.gz',
                                                     '2019_metadata_02.tsv.gz')),
                                     fluidRow(tags$a(href='https://hpc.nih.gov/~mcgaugheyd/eyeIntegration/2019_gene_TPM_02.tsv.gz',
                                                     '2019_gene_TPM_02.tsv.gz')),
                                     fluidRow(tags$a(href='https://hpc.nih.gov/~mcgaugheyd/eyeIntegration/2019_tx_TPM_02.tsv.gz',
                                                     '2019_tx_TPM_02.tsv.gz')),
