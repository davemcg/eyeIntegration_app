               ...
               navbarMenu('Data',
                          ...
                          tabPanel('Data Download',
                                   fluidPage(
                                     ...
                                     fluidRow(tags$a(href='https://hpc.nih.gov/~mcgaugheyd/eyeIntegration/2017_metadata_03.tsv.gz',
                                                     '2017_metadata_03.tsv.gz')),
                                     fluidRow(tags$a(href='https://hpc.nih.gov/~mcgaugheyd/eyeIntegration/2017_gene_TPM_03.tsv.gz',
                                                     '2017_gene_TPM_03.tsv.gz')),
                                     fluidRow(tags$a(href='https://hpc.nih.gov/~mcgaugheyd/eyeIntegration/2017_tx_TPM_03.tsv.gz',
                                                     '2017_tx_TPM_03.tsv.gz')),
                                     fluidRow(tags$a(href='https://hpc.nih.gov/~mcgaugheyd/eyeIntegration/2019_metadata_03.tsv.gz',
                                                     '2019_metadata_03.tsv.gz')),
                                     fluidRow(tags$a(href='https://hpc.nih.gov/~mcgaugheyd/eyeIntegration/2019_gene_TPM_03.tsv.gz',
