               ...
               navbarMenu('Data',
                          ...
                          tabPanel('Data Download',
                                   fluidPage(
                                     ...
                                     fluidRow(tags$a(href='https://hpc.nih.gov/~mcgaugheyd/eyeIntegration/2017_metadata01.tsv.gz',
                                                     '2017_metadata01.tsv.gz')),
                                     fluidRow(tags$a(href='https://hpc.nih.gov/~mcgaugheyd/eyeIntegration/2017_gene_TPM01.tsv.gz',
                                                     '2017_gene_TPM01.tsv.gz')),
                                     fluidRow(tags$a(href='https://hpc.nih.gov/~mcgaugheyd/eyeIntegration/2017_tx_TPM01.tsv.gz',
                                                     '2017_tx_TPM01.tsv.gz')),
                                     fluidRow(tags$a(href='https://hpc.nih.gov/~mcgaugheyd/eyeIntegration/2019_metadata01.tsv.gz',
                                                     '2019_metadata01.tsv.gz')),
                                     fluidRow(tags$a(href='https://hpc.nih.gov/~mcgaugheyd/eyeIntegration/2019_gene_TPM01.tsv.gz',
                                                     '2019_gene_TPM01.tsv.gz')),
                                     fluidRow(tags$a(href='https://hpc.nih.gov/~mcgaugheyd/eyeIntegration/2019_tx_TPM01.tsv.gz',
                                                     '2019_tx_TPM01.tsv.gz')),
