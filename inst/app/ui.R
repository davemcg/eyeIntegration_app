                          ...
                          tabPanel('FAQs', fluidPage(
                            ...
                            navlistPanel("Pan-Tissue Expression FAQs", 
                                         ...
                                         tabPanel("How do I interpret the 'Decile' column in the data table?",
                                                  "To give a rough sense of how highly expressed the gene is in the tissue, the decile of expression is given in [10]; 10 is the highest decile of expression and 1 is the lowest.", br(), br(), img(src='pantissue_screenshot.jpg', width = 900), br(), br()),
